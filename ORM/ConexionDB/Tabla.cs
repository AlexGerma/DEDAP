...
namespace ConexionDB
{
    public class Tabla
    {
        ...
        public bool CreaTabla2() {
            return ExecuteQuery.CreaTabla(CreateTable());
        }
        ...
        public bool Insert(){
            return ExecuteQuery.InsertInto(InsertInto());
        }
    ...
    public class Clientes : Tabla {
        public class SubCliente : Clientes{
            public SubCliente()
            {
                //this.Registros.Add(this.columnas[0].Value.ToString());
            }
        }
        public Clientes()
        {
            ...
            this.columnas.Add(new Columna("nombre_cliente", TipoDeCampo.Varchar, 20, false, null, Indices.NULL, "Name of Clients",null));
        ...
        public List<SubCliente> Registros = new List<SubCliente>();
        public string Name {
